...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// DO NOT MODIFY ANY WEBSOCKET GATEWAY CONFIGURATION
// This gateway is configured and working correctly with the following settings:
// - Path: /socket.io (DO NOT CHANGE THIS)
// - CORS: Configured for localhost:3000 and localhost:3002
// - Authentication: Working with Clerk JWT
// - Event handlers: Properly configured for messages, reactions, and channels
// Any changes to these configurations will break the WebSocket functionality
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
@WebSocketGateway({
  ...
  path: '/socket.io',  // DO NOT CHANGE THIS PATH
